...
app = FastAPI(
    ...
    description="Speech-to-Text and Text-to-Speech for Cantonese chat room messages. "
                "Optimized for short audio (max 15 seconds) with Traditional Chinese output.",
    version="1.0.0",
    lifespan=lifespan
)
...
async def speech_to_text_endpoint(
    ...
    audio: UploadFile = File(..., description="Audio file (OGG/MP3/WAV, max 15 seconds)")
):
    """
...
async def text_to_speech_endpoint(
    ...
    - **text**: Text to convert to speech (max 500 characters)
